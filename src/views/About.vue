<template>
  <div class="detail" v-if="restaurant" @scroll="scrollHandler" >
    <div class="shop-header" v-if="restaurant.shop_sign" id="shop-header">
      <nav class="nav-img"
    ...
    <Tab class="shop-tab" :tabs="tabs" ref="shopTab"  id="shopTab" @index="current"></Tab>
    ...
    <div class="shop-cart-wrapper">
      <Shop-cart
              ...
              :batch_shop="allGoods"
              :delivery-price="restaurant.delivery_fee_discount+restaurant.float_delivery_fee"
              :min-price="restaurant.float_minimum_order_amount"
              :shake="shake"
              v-show="currentIndex<2"
      ></Shop-cart>
    </div>
    <Spec-Panel @shake="shakeCart" v-if="Object.keys(specInfo).length>0" :brand="specInfo" :showP="Object.keys(specInfo).length>0&&specInfo.showInfo" ></Spec-Panel>
  </div>

</template>

<script type="text/ecmascript-6">
  import restaurants from '../assets/seller.json';
  import cart_clients from '../assets/cart_client';
  import batch_shop from '../assets/batch_shop'
  import {mapGetters,mapActions} from 'vuex'
    ...
    import Goods2 from '../components/goods/goods2.vue'
    import Tests from '../components/goods/test'
    import ShopCart from '../components/shop-cart/shop-cart'
    import SpecPanel from '../components/spec-panel/spec-panel'
    ...
    export default {
        ...
        components: {
            ActionSheet,Pop,Tab,ShopCart,SpecPanel
        },
        computed:{
            ...mapGetters(['specInfo','allGoods']),
            tabs() {
                return [
                    {
                        label: '招牌',
        ...
        created() {
            ...
            this.setAllGoods(this.goods)
           // console.log(this.restaurant)
        },
        methods: {
            ...mapActions(['setAllGoods']),
